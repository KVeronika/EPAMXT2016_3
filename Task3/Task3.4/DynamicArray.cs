...
namespace Task3._4
{
    public class DynamicArray<T> : IList<T>, IList, ICollection<T>, ICollection, IEnumerable<T>, IEnumerable, ICloneable
    {
        ...
        public int Length
        {
            ...
            private set
            {
                Array.Resize(ref this.internalArray, value);
            }
        }
        ...
        public T this[int index]
        {
            get
            {
                ...
                if (index < 0)
                {
                    return this.internalArray[this.Length + index];
                }
            ...
            set
            {
                ...
                if (index < 0)
                {
                    this.internalArray[this.Length + index] = value;
                }
        ...
        public T[] ToArray()
        {
            ...
            Array.Copy(this.internalArray, temp, this.Length);
            return temp;
        }
